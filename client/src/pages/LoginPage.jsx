    ...
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly 
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {currState === "Sign up" && !isDataSubmitted && (
          ...
          type="text" className='p-2 border border-gray-500 rounded-md foucs:outline-none'
...

        {
          currState === "Sign up" && isDataSubmitted && (
            ...
            rows={4} className='p-2 border border-gray-500 roundedn-md focus:outline-none focus:ring-2
